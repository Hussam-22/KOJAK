    ...
    <>
      <Container sx={{ py: 5 }}>
        <Stack spacing={3} sx={{ textAlign: 'center' }}>
          ...
          <Typography>
            We understand the importance of a well-maintained vehicle. Our team of skilled
            technicians is committed to keeping your car running smoothly and safely. With years of
            experience and state-of-the-art equipment, we offer a comprehensive range of auto repair
