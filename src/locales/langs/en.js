const en = {
  ...
  landing: {
    ...
    spotLight: {
      spotLight: 'Spotlight',
      title: 'Spotlight Vehicles',
      subTitle: `Welcome to our collection of spotlight vehicles, where extraordinary meets the road. These handpicked gems are more than just automobiles; they're a testament to innovation, design, and performance. Each spotlight vehicle in our inventory has been carefully selected to elevate your driving experience and turn heads wherever you go. Explore these exceptional rides below.`,
    },

    international: {
      title: 'International Destination for Mercedes-Benz automotive',
      subTitle: `Catering to discerning customers from over 50 countries worldwide, Kojak-Exclusive has
    ...
    spareParts: {
      ...
      subText:
        'Looking for Geniun Parts for your Mercedes, Visit Kojak Spare-Parts Shop or explore our spare-parts inventory online by visiting Kojak Spare-Parts Website',
