...
const en = {
  ...
  contactUs: {
    ...
    details: {
      ...
      hours: '9 AM to 4 PM - Saturday to Thursday',
      follow: 'FOLLOW US',
    },
  },
  ...
  form: {
    ...
    whatsApp: {
      ...
      workingHours: 'Our working hours from 9 AM to 4 PM, Saturday to Thursday',
    },
  },
  ...
  propertyCard: {
    ...
    flat: 'Flat',
    showrooms: 'showrooms',
    'healthclub/swimmingpool': 'Health Club / Swimming Pool',
    labourcamp: 'labour camp',
    shops: 'Shops',
    restaurant: 'Restaurant',
    offices: 'Offices',
